    ...
    return (
        <div className="p-2 max-w-[900px] text-blue-200">
            ...
            <p>
                ...
                We don't want to lock the UI thread while doing this, so the task is dispatched the to a Web Worker, which carries 
                out the task in a seperate thread then sends a message with the result upon completion.
            ...
            <p>
                ...
                The app was given an icon and configured to cache resources.    
            </p>        
            <p>
